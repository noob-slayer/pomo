...
// no longer generated by the UI (one link now — the live session — replaced this), but
// parsing stays so any settings-link someone already shared during earlier testing still works
